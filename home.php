...
?>
<p class="text-center"></br><b> Welcome<br></b><?php echo $name?></p>
<div class="text-center fixed-bottom" >Want to leave page?<br>
<button class="btn btn-primary bg-light"  id="btn1"><a href="logout.php">logout</a></button></div>
</form>
</div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget subscribe no-box">
                            <h5 class="widget-title">World Bank<span></span>
                            </h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            ...
                            <ul class="thumbnail-widget">
                                ...
                                <li>
                                    <div class="thumb-content"><a href="#">Premium customres</a></div>
                                </li>
                                <li>
                                    <div class="thumb-content"><a href="#">Sucess stories</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p>Copyright Basic bank© 2015. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
